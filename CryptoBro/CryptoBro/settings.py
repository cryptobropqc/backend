...
SECRET_KEY = 'django-insecure-aqn6%1qfmez3w!t%9*dsz#lh7s!v83(5#v1zl2h3o&0-#@q=h^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['localhost','127.0.0.1','3.94.82.74', '52.91.232.233']
# ALLOWED_HOSTS = [
#     'localhost',
#     '127.0.0.1',
#     '[::1]',
...
# # Абстракция Usera для app account
